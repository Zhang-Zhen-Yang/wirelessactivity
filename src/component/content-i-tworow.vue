 ...
 * @Date: 2018-10-31 15:30:31 
 * @Last Modified by: zhangzhenyang
 * @Last Modified time: 2018-12-03 10:10:17
 */
<template>
  <div class="temp">
    <div class="content-item-title">双列宝贝模块</div>
    <div class="content-item-wrap">
      <tab-setting>
        ...
        <div slot="second">
          <!--动态组件列表-->
          <dynamic-list type="twoRow" :itemData="itemData"></dynamic-list>
        </div>
      </tab-setting>
    </div>
  </div>

 ...
 * @Date: 2018-10-31 15:29:17 
 * @Last Modified by: zhangzhenyang
 * @Last Modified time: 2018-12-03 10:08:17
 */

<template>
  <div class="temp">
    <div class="content-item-title">组合宝贝模块</div>
    <div class="content-item-wrap">
      <tab-setting>
        <!--1-->
        <div slot="first">
          <div class="content-item-sub-title">模块标题</div>
          <w-input type="text" class="" v-model="itemData.title" placeholder="请输入模标题" />
          <p></p>
          <div class="content-item-sub-title">更多链接</div>
          <div class="relative">
            <w-input type="text" class="" v-model="itemData.link" placeholder="请输入链接" />
            <link-icon :itemData="itemData" :itemIndex="0" :mapKey="'link'"></link-icon>
          </div>
          <p></p>
          <tab-layout>
            <div slot="one">
              <goods-item-layout :list="itemData.list"></goods-item-layout>
        ...
        <div slot="second">
          <!--动态组件列表-->
          <dynamic-list type="groupGoods" :itemData="itemData"></dynamic-list>
        </div>
      </tab-setting>
    </div>
  </div>

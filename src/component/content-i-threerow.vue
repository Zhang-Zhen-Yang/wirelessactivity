 ...
 * @Date: 2018-10-31 15:30:25 
 * @Last Modified by: zhangzhenyang
 * @Last Modified time: 2018-12-03 10:10:07
 */

<template>
  <div class="temp">
    <div class="content-item-title">九宫格宝贝模块</div>
    <div class="content-item-wrap">
      <tab-setting>
        ...
        <div slot="second">
          <!--动态组件列表-->
          <dynamic-list type="threeRow" :itemData="itemData"></dynamic-list>
        </div>
      </tab-setting>
    </div>
  </div>

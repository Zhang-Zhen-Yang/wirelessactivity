 ...
 * @Last Modified time: 2019-01-19 09:19:35
 */


<template>
  <div class="temp">
    <div class="content-item-title">收藏店铺</div>
    <div class="content-item-wrap">
      ...
      <!-- 收藏店铺样式 -->
      <div class="content-item-sub-title">收藏店铺样式</div>
      <!-- {{ favoriteWidgets }} -->
      <dynamic-list type="favorite" :itemData="itemData" :block="true"></dynamic-list>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    // 动态组件
    favoriteWidgets() {
      return this.$store.state.dynamic.widgets.favorite;
    }
  },
  methods: {
    selectImage() {

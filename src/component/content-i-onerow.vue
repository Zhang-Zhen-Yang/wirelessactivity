 ...
 * @Date: 2018-10-31 15:29:41 
 * @Last Modified by: zhangzhenyang
 * @Last Modified time: 2018-12-03 10:09:12
 */

<template>
  <div class="content-item-onerow">
    <div class="content-item-title">单列宝贝模块</div>
    <div class="content-item-wrap">
      <tab-setting>
        ...
        <div slot="second">
          <!--动态组件列表-->
          <dynamic-list type="oneRow" :itemData="itemData"></dynamic-list>
        </div>
      </tab-setting>

 ...
 * @Date: 2018-10-31 15:29:50 
 * @Last Modified by: zhangzhenyang
 * @Last Modified time: 2018-12-03 10:09:21
 */

<template>
  <div class="temp">
    <div class="content-item-title">左右图文模块</div>
    <div class="content-item-wrap">
      <tab-setting>
        ...
        <div slot="second">
          <!--动态组件列表-->
          <dynamic-list type="oneRowHorizontal" :itemData="itemData"></dynamic-list>
        </div>
      </tab-setting>
    </div>
  </div>
...
<script>
export default {
  name: 'content-i-onerowhorizontal',
  props: {
    itemData:{
      type: Object,
      default() {

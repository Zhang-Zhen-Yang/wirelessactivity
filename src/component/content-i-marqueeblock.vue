 ...
 * @Date: 2018-10-31 15:29:31 
 * @Last Modified by: zhangzhenyang
 * @Last Modified time: 2018-12-03 10:08:57
 */

<template>
  <div class="content-item-marquee">
    <div class="content-item-title">滚动宝贝模块</div>
    <div class="content-item-wrap">
      <tab-setting>
        ...
        <div slot="second">
          <!--动态组件列表-->
          <dynamic-list type="marqueeBlock" :itemData="itemData"></dynamic-list>
        </div>
      </tab-setting>
    </div>
  </div>
